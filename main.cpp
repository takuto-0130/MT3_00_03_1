...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		Novice::ScreenPrintf(0, 0, "%6.2f%6.2f%6.2f  transformd", transformd.x, transformd.y, transformd.z);
		MatrixScreeenPrintf(0, kRowHeight, translateMatrix, "translateMatrix");
		MatrixScreeenPrintf(0, kRowHeight * 6, scaleMatrix, "scaleMatrix");
